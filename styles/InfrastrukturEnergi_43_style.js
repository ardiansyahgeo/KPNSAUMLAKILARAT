var size = 0;
var placement = 'point';
function categories_InfrastrukturEnergi_43(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Pembangkit Listrik Lainnya':
...
var style_InfrastrukturEnergi_43 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_InfrastrukturEnergi_43(feature, value, size, resolution, labelText,
