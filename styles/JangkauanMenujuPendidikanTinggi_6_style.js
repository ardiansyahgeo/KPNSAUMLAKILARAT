var size = 0;
var placement = 'point';
function categories_JangkauanMenujuPendidikanTinggi_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Lokasi Pendidikan Tinggi':
...
var style_JangkauanMenujuPendidikanTinggi_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_JangkauanMenujuPendidikanTinggi_6(feature, value, size, resolution, labelText,
